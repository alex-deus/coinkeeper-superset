...
- Django Admin: [localhost:8000/admin/](http://localhost:8000/admin/) - **admin** / **admin** (_managing the database content_)
- Apache Superset: [localhost:8088](http://localhost:8088) - **admin** / **admin** (_data visualization & analytics_)
